...
def refresh_channels():
    ...
    logger.info("🔄 Refreshing soil moisture probes from DB...")
    soil_init_channels()  # Re-runs full init
    logger.info(f"Refreshed: {len(SENSORS)} active soil moisture probes")